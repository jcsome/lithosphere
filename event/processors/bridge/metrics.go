...
type L1Metricer interface {
	...
	RecordL1LatestRollupSateRootHeight(height *big.Int)
	RecordL1LatestRollupMantleDaHeight(height *big.Int)

	RecordL1LatestProvenHeight(height *big.Int)
...
func (m *bridgeMetrics) RecordL1LatestRollupSateRootHeight(height *big.Int) {
	m.latestHeight.WithLabelValues("l1", "state_root").Set(float64(height.Uint64()))
}

func (m *bridgeMetrics) RecordL1LatestRollupMantleDaHeight(height *big.Int) {
	m.latestHeight.WithLabelValues("l1", "mantle_da").Set(float64(height.Uint64()))
}
...
func (m *bridgeMetrics) RecordL1LatestProvenHeight(height *big.Int) {
	m.latestHeight.WithLabelValues("l1", "finalized").Set(float64(height.Uint64()))
}
